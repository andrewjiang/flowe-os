// Copied VERBATIM from x4-os src/activities/reader/ProgressFile.h.
// Only change: <Logging.h> -> "ReaderLog.h" (same LOG_* call sites; the
// ReaderFs shim supplies <HalStorage.h> with HalFile + the Storage singleton).
#pragma once
